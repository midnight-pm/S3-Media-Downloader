<?php
	...
	/*
		This function is used to determine if aws is installed and readily accessible
		via PATH.

		If aws is found, then it will return "true". If it is not found, then it will
		return false.
	...
	*/
	if(!function_exists("aws_verify_install"))
	{
		function aws_verify_install($path) :bool
		{
			/*
			...
			*/
			...
			/*
				Evaluate to determine how to check for the availability of aws.
