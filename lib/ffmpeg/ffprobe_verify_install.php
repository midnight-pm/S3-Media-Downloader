<?php
	...
	/*
		This function is used to determine if ffprobe is installed and readily accessible
		via PATH.

		If ffprobe is found, then it will return "true". If it is not found, then it will
		return false.
	...
	*/
	if(!function_exists("ffprobe_verify_install"))
	{
		function ffprobe_verify_install($path) :bool
		{
			/*
			...
			*/
			...
			/*
				Evaluate to determine how to check for the availability of ffprobe.
